...
Este artículo ofrece ejemplos del uso básico de la syntaxis de Markdown that can be used in Hugo content files, also it shows whether basic HTML elements are decorated with CSS in a Hugo theme.
<!--more-->
